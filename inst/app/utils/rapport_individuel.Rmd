...
file.rename(from = ff, to = file.path(outdir,Sys.Date(),v,"Propriétés","Arbres éclairés",paste0(v,"_","Ancrage.pdf")))
...
file.rename(from = ff, to = file.path(outdir,Sys.Date(),v,"Propriétés","Arbres éclairés",paste0(v,"_","CAP.pdf")))

ff <- file.path(outdir,Sys.Date(),v,"Propriétés","Arbres éclairés",paste0(v,"_","Responsabilité globale.pdf"))
file.rename(from = ff, to = file.path(outdir,Sys.Date(),v,"Propriétés","Arbres éclairés",paste0(v,"_","RESP.pdf")))

ff <- file.path(outdir,Sys.Date(),v,"Propriétés","Arbres éclairés",paste0(v,"_","Arbre synthétique.pdf"))
file.rename(from = ff, to = file.path(outdir,Sys.Date(),v,"Propriétés","Arbres éclairés",paste0(v,"_","SYNTH.pdf")))
...
file.rename(from = ff, to = file.path(outdir,Sys.Date(),v,"Propriétés","Arbres éclairés",paste0(v,"_","global.pdf")))
...
knitr::include_graphics(file.path(outdir,Sys.Date(),prefix,"Propriétés","Arbres éclairés",paste0(prefix,"_","global.pdf")))
```
\end{minipage}}
